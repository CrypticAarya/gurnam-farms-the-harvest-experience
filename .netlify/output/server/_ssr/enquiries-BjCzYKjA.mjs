...
import { l as fetchUserEnquiries } from "./router-GyR_-4HA.mjs";
import "./index.mjs";
...
function EnquiriesPage() {
  const query = useQuery({
    queryKey: ["user", "enquiries"],
    queryFn: fetchUserEnquiries
  });
  const items = query.data ?? [];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-cream p-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-semibold text-forest-deep", children: "My Enquiries" }),
