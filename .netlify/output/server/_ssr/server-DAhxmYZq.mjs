...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-suhPzunQ.mjs");
...
const manifest = {
  "a1fa375f149012194411533ff6115d1cc74f48f6a2e6e8606691b0e0ad71d333": {
    functionName: "sendReservationConfirmationEmail_createServerFn_handler",
    importer: () => import("./email.functions-108wZsru.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-GyR_-4HA.mjs").then((n) => n.r),
    import("./start-DwMTee8R.mjs"),
